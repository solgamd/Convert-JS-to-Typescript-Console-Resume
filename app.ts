...
let person = [          //Is this type argument inference? i.e. no need to 'type' it
    ["Name:", "Megan Solga"],
...
let skills: string[] = ['Spanalan', 'steel drum solos', 'grammar', 'hand eye coordination', 'getting weird tattoos']
...
function displayPosition(jobTitle: string, companyName: string, descrip: string) {
...
//To log My Skills
function displaySkill(skills: string, coolness: boolean) {
    if (coolness === true) {
